        ...
        <div className='flex flex-col items-center pb-24 pt-8 text-center sm:pb-32 sm:pt-12'>
          ...
          <Reveal delay={0.15}>
            <div className='mt-11 flex flex-col items-center gap-6'>
              <a
                href='#contact'
                className='group inline-flex items-center gap-2.5 rounded-xl bg-paper px-8 py-4 text-sm font-medium text-ink transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:bg-accent hover:text-white'
              >
                Get in touch
                <Icon
        ...
        <div className='flex flex-col items-center justify-between gap-6 border-t border-white/10 py-8 md:flex-row'>
          ...
          <div className='flex gap-2.5'>
            ...
            <a
              ...
              className='flex h-10 w-10 items-center justify-center rounded-lg border border-white/12 text-paper/70 transition-all duration-300 hover:-translate-y-0.5 bg-[#25D366] hover:bg-[#1ebe5b]'
            >
